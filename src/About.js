        ...
        <Col lg={{span: 8, offset: 2}} md={12}>
          ...
          <p>
            <Trans t={t} i18nKey="about.about_confessit_text">
              ConfessIt is a <a href="https://www.vatican.va/content/vatican/en.html">Roman Catholic</a> examination of conscience for computers, tablets, and phones. It's designed to be simple and easy to use, and it can help you remember your sins when you go to confession. There's also a confession walkthrough that tells you exactly what the priest will say and how you should respond - a great resource if you haven't been to confession in a while! The examination of conscience is based on fundamental Catholic church teachings, is easy to understand, and is relevant for modern Catholics.
            </Trans>
          </p>
          ...
          <p>
            {t('about.about_confession_intro')}
          </p>
          <blockquote>
          ...
          <p>
            <Trans t={t} i18nKey="about.this_app_is_designed">
              This app is designed to help Roman Catholics prepare for the sacrament of confession by examining their conscience. It is <strong>NOT</strong> a substitute for confession.
            </Trans>
          </p>

          <p>
            {t('about.please_be_respectful')}
          </p>

          <p>
            <Trans t={t} i18nKey="about.this_website">
              This website, <a href="https://confessit.app">ConfessIt.app</a>, is based on the <a href="https://play.google.com/store/apps/details?id=com.mikekasberg.confessit">ConfessIt Android App</a> (created in 2012 by the same developer). While it's not (yet) a complete reproduction, it aims to make the app available to a wider range of users on a broader range of devices. (This site works on iOS, Android, tablets, and computers!)
            </Trans>
          </p>

          <p>
            <Trans t={t} i18nKey="about.if_you_find">
              If you find this app useful, please consider <strong>sharing it</strong> with your friends and family. Tell people about it on Facebook, Reddit, Twitter, at your church, or in your Bible study group to help spread the word!
            </Trans>
          </p>
          ...
          <p>
            <Trans t={t} i18nKey="about.confessit_is_open_source">
              ConfessIt is open source. We develop the app on <i className="fa fa-github"></i> <a href="https://github.com/kas-catholic/confessit-web">GitHub</a> and we collaborate in the <a href="https://www.opensourcecatholic.com/chat">Open Source Catholic</a> community on Slack.
            </Trans>
          </p>
          ...
          <p>
            <Trans t={t} i18nKey="about.confessit_is_translated">
              ConfessIt is translated into multiple languages. If you'd like to help with this effort by adding a new translation or improving an existing translation, please read about how to do so on <a href="https://github.com/kas-catholic/confessit-web/blob/main/CONTRIBUTING.md#contributing-translations">GitHub</a> or get in touch with us on <a href="https://www.opensourcecatholic.com/chat">Open Source Catholic</a> Slack.
            </Trans>
          </p>
          ...
          <p>
            <Trans t={t} i18nKey="about.we_welcome_new_contributions">
              We welcome new contributions. If you'd like to contribute to ConfessIt, the best way to begin is by reading about how to do so on <a href="https://github.com/kas-catholic/confessit-web/blob/main/CONTRIBUTING.md">GitHub</a>.
            </Trans>
          </p>
          ...
          <p>
            <Trans t={t} i18nKey="about.mike_kasberg">
              <a href="https://www.mikekasberg.com">Mike Kasberg</a> develops ConfessIt in his free time, as a way of giving back to the church. He is also involved in a few other small projects to support Catholic organizations with technology.
            </Trans>
          </p>
