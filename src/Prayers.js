    ...
    return <Container className="text-justify mt-4">
      <Row>
        <Col lg={{span: 8, offset: 2}} md={12}>
          ...
          <ul>
            <li><a href="#prayer-before-confession">Prayer Before Confession</a></li>
            <li><a href="#act-of-contrition">Act of Contrition</a></li>
            <li><a href="#another-act-of-contrition">Another Act of Contrition</a></li>
            <li><a href="#thanksgiving-after-confession">Thanksgiving After Coinfession</a></li>
            <li><a href="#our-father">Our Father</a></li>
            <li><a href="#hail-mary">Hail Mary</a></li>
            <li><a href="#hail-holy-queen">Hail Holy Queen</a></li>
          </ul>

          <h2 className="anchor-pad" id="prayer-before-confession">Prayer Before Confession</h2>
          <p>My Lord and God, I have sinned. I am guilty before you.<br />
          ...
          <h2 className="anchor-pad" id="act-of-contrition">Act of Contrition</h2>
          <p>My God,<br />
          ...
          <h2 className="anchor-pad" id="another-act-of-contrition">Another Act of Contrition</h2>
          <p>O my God,<br />
          ...
          <h2 className="anchor-pad" id="thanksgiving-after-confession">Thanksgiving After Confession</h2>
          <p>My dearest Jesus,<br />
          ...
          <h2 className="anchor-pad" id="our-father">Our Father</h2>
          <p>Our Father,<br />
          ...
          <h2 className="anchor-pad" id="hail-mary">Hail Mary</h2>
          ...
          <h2 className="anchor-pad" id="hail-holy-queen">Hail Holy Queen</h2>
