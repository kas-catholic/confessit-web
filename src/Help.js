        ...
        <Row>
          <Col lg={{ span: 8, offset: 2 }} md={12}>
            ...
            <ol>
              ...
              <li>
                <Trans t={t} i18nKey="help.step_3">
                  If you're unsure what to say in confession, swipe to the next
                  tab, <strong>Walkthrough</strong>, to see roughly what you and
                  the priest will say to each other in confession. You can
                  review this during confession if you wish.
                </Trans>
              </li>
              <li>
